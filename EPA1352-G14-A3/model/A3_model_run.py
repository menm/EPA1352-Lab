...
# Batch run the model, for the specified scenarios, number of iterations and number of steps
parameter_sweep = {'seed': range(88888888, 88888890), 'scenario': range(1,6)}
...
df_batch.to_csv('../data/A3_scenarios_data.csv', index=False)
